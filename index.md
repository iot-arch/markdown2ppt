...
$ https://arch.run new slide.md

# create a new slide straight from a github template
$ https://arch.run new slide.md -t username/repo

# start local sever show slide
$ https://arch.run serve slide.md

# to build a slide
$ https://arch.run build slide.md
```
...
快使用 [nodeppt](https://arch.run) 轻松搞定高大上 PPT<br/> https://arch.run 助力你的人生逆袭之路！ {.text-into.animated.delay-800.fadeIn}
